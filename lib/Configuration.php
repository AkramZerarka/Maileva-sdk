...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sandbox.maileva.net/registered_mail/v2';

    /**
     * User agent of the HTTP request, set to "PHP-Maileva" by default
     *
     * @var string
     */
    protected $userAgent = 'Maileva-Codegen/1.0.0/php';
    ...
    {
        $report  = 'PHP SDK (Maileva\Client) Debug Report:' . PHP_EOL;
