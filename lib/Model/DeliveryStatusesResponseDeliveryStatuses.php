<?php
/**
 * DeliveryStatusesResponseDeliveryStatuses
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DeliveryStatusesResponseDeliveryStatuses Class Doc Comment
 *
 * @category Class
 * @package  Maileva\Client
 * @author   Maileva Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryStatusesResponseDeliveryStatuses implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'delivery_statuses_response_delivery_statuses';
...
'date' => 'getDate'    ];
     ...
     * Sets status
     *
     * @param string $status Identifiant du statut de distribution
     *
     * @return $this
     */
     ...
     * Sets label
     *
     * @param string $label Statut de distribution
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param string $date Date du statut de distribution
     *
     * @return $this
     */
